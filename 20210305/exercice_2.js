...
nomsDesVilles = villes => villes.nom();
villes.filter(nomsDesVilles)
...
villesDePlusDe30000Habitants = villes => villes.population.lenght(<30000)
...
habitantsYverdon = villes => villes.nom("Yverdon")

habitantsYverdon.filter(villes.population)
